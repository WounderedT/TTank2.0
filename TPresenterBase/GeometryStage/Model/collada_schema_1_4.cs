...
// Author: @lx
//------------------------------------------------------------------------------
// Code was updated to fix several issues and improve usability for TTank2.0
//------------------------------------------------------------------------------
// <auto-generated>
...
//    [DebuggerStepThrough]
    ...
    [DesignerCategory("code")]
    [XmlType(AnonymousType = true, Namespace = "http://www.collada.org/2005/11/COLLADASchema")]
    public class effectFx_profile_abstractProfile_COMMONTechniqueBlinn : effectFx_profile_abstractProfile_COMMONTechniqueLambert
    {
    ...
    [DesignerCategory("code")]
    [XmlType(AnonymousType = true, Namespace = "http://www.collada.org/2005/11/COLLADASchema")]
    public class effectFx_profile_abstractProfile_COMMONTechniqueLambert : effectFx_profile_abstractProfile_COMMONTechniqueConstant
    {
    ...
    [DesignerCategory("code")]
    [XmlType(AnonymousType = true, Namespace = "http://www.collada.org/2005/11/COLLADASchema")]
    public class effectFx_profile_abstractProfile_COMMONTechniquePhong : effectFx_profile_abstractProfile_COMMONTechniqueLambert
    {
        private common_float_or_param_type shininessField;
        private common_color_or_texture_type specularField;
    ...
    public class Mesh
    {
        ...
        public object[] Items
        {
            ...
            set
            {
                ...
                {
                    _steps = new Int32[itemsField.Length];
                    _offsets = new Offset[itemsField.Length];
                    for (var ind = 0; ind < itemsField.Length; ind++)
                    {
                        if(itemsField[ind] is Triangles triangles)
                        {
                            _steps[ind] = (Int32)(triangles.input[triangles.input.Length - 1].offset + 1);
                            _offsets[ind].Offsets = new Dictionary<OffsetSemantic, int>();
                            foreach (var input in triangles.input)
                            {
                                _offsets[ind].Offsets.Add((OffsetSemantic)Enum.Parse(typeof(OffsetSemantic), input.semantic), (Int32)input.offset);
                            }
                            _offsets[ind].BuildOffsets();
                        }
                    }
                }
            }
        ...
        public Offset GetOffset(Int32 index)
        {
            return _offsets[index];
        }

        public Int32 GetStep(Int32 index)
        {
            return _steps[index];
        }

        public TrianglePoint[] GetTrianglePointsAsArray(Int32 index)
        {
            if (Items[index] is Triangles triangles)
            {
                var array = COLLADA.ParseStringAsArrayInt32(triangles.p);

                String[] semantics = new String[triangles.input.Length];
                for(var ind = 0; ind < semantics.Length; ind++)
                {
                    semantics[ind] = triangles.input[ind].semantic;
                }

                TrianglePoint[] points = new TrianglePoint[triangles.count * 3];
                Int32 k = 0;
                Int32 step = _steps[index];
                for (var ind = 0; ind < array.Length; ind += step)
                {
                    Int32[] tmp = new int[step];
                    for(var j = 0; j < step; j++)
                    {
                        tmp[j] = array[ind + j];
                    }
                    points[k] = new TrianglePoint(semantics, tmp);
                    k++;
                }
                return points;
            }
        ...
        public Int32[] GetTrianglePointsRaw(Int32 index)
        {
            if (Items[index] is Triangles triangles)
            {
                return COLLADA.ParseStringAsArrayInt32(triangles.p);
            }
            else
            {
                return null;
        ...
        public UInt64 GetTrianglesCount(Int32 index)
        {
            if(Items[index] is Triangles triangles)
            {
    ...
    public class Node
    {
        ...
        [XmlElement("matrix", typeof (MatrixCollada))]
    ...
    [XmlType(AnonymousType = true, Namespace = "http://www.collada.org/2005/11/COLLADASchema")]
    [XmlRoot(Namespace = "http://www.collada.org/2005/11/COLLADASchema", IsNullable = false)]
    public class MatrixCollada
    {
        private string sidField;

        private double[] valuesDouble;
        private Single[] valuesSingle;
        private String textField;
        ...
        {
            get { return COLLADA.ParseStringAsArrayDouble(textField); }
            set { textField = COLLADA.ConvertFromArray<Double>(value); }
        }

        [XmlIgnore]
        public Single[] ValuesSingle
        {
            get { return COLLADA.ParseStringAsArraySingle(textField); }
            set { textField = COLLADA.ConvertFromArray<Single>(value); }
        }
    }
    ...
    public partial class COLLADA
    {
        ...
        #region ParseStringAs Methods

        public static Double[] ParseStringAsArrayDouble(String toParse)
        {
            String[] values = regex.Split(toParse.Trim());
        ...
        public static Single[] ParseStringAsArraySingle(String toParse)
        {
            String[] values = regex.Split(toParse.Trim());
        ...
        public static Int32[] ParseStringAsArrayInt32(String toParse)
        {
            String[] values = regex.Split(toParse.Trim());
        ...
        public static T[] ParseStringAsArray<T>(String toParse) where T : struct
        {
            String[] values = regex.Split(toParse.Trim());
            T[] result = new T[values.Length];
            MethodInfo method = typeof(T).GetMethod("Parse", new[] { typeof(string), typeof(CultureInfo) });
            for (int i = 0; i < values.Length; i++)
                result[i] = (T)method.Invoke(null, new object[] { values[i], CultureInfo.InvariantCulture });
            return result;
        }

        #endregion

        public static T FindEntryByType<T>(COLLADA model) where T : class
        {
            Type t = typeof(T);
    ...
    {
        private Int32 _vertexOffset;
        private Int32 _normalOffset;
        private Int32 _texcoordOffset;
        ...
        {
            get { return _texcoordOffset; }
        }

        public Dictionary<OffsetSemantic, Int32> Offsets;

        public void BuildOffsets()
        {
            _vertexOffset = Offsets[OffsetSemantic.VERTEX];
            _normalOffset = Offsets[OffsetSemantic.NORMAL];
            _texcoordOffset = Offsets[OffsetSemantic.TEXCOORD];
        }
    }
    ...
    public struct TrianglePoint
    {
        ...
        public TrianglePoint(String[] semantics, params Int32[] points)
        {
            Semantics = semantics;
            Points = points;
        }
